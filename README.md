...
*Screenshot is generated by the automated Playwright capture (`npm run screenshot` / `.github/workflows/screenshot.yml`) in test mode; run the script locally if the image is missing*
