/**
 * ancient-stone-family.ts — reusable periodic 3D rubble/ashlar stone factory.
 *
 * Like brick-family.ts, this centralizes material-family geometry. The family
 * produces coherent top/south/east face slices from a shared periodic 3D
 * weighted Voronoi volume, while palette specs control colour/material mood.
 */
