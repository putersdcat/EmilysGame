/**
 * fence-family.ts — reusable procedural rustic fence style family.
 *
 * Unlike masonry wall materials, fences/gates are rendered as procedural
 * geometry in nano-tile.ts. This module is the source of truth for the
 * MATERIAL + CONSTRUCTION presets used by those procedural primitives.
 *
 * Each preset answers two questions:
 *   1) What is this thing in the physical world? (post-and-rail, picket, wattle…)
 *   2) What age / exposure state is it in? (bleached, mossy, split, weathered…)
 */

import type { FenceStyle } from '../types';

function style(spec: FenceStyle): FenceStyle {
