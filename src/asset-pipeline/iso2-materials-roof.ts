/**
 * iso2-materials-roof.ts — roof material primitives (experiment roof-family.ts).
 *
 * Produces 144×144 SVG textures for roof nano primitives: slope-left, slope-right,
 * ridge, and gable. Sloped isometric clipping lands in D.10 (nano-tile.ts).
 */
...
/** Warm straw thatch — cottage roof proof material (experiment thatch-roof.ts). */
const THATCH_PALETTE: RoofPaletteSpec = {
  base: '#a98a38',
  dark: '#5f4b22',
  light: '#e2c766',
...
export const ThatchRoof = createRoofMaterial(THATCH_PALETTE);