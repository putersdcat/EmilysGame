...
export const BIOME_DEFS: BiomeDef[] = [
  {
    ...
    obstacleWeights: { rock: 0.15, bush: 0.25, tree: 0.12, tree_pine: 0.12, tree_palm: 0.12, fence: 0.06, house: 0.06, hut: 0.04, campfire: 0.04, shop: 0.04 },
  ...
  },
  {
    ...
    obstacleWeights: { wall: 0.28, door_locked: 0.16, barricade: 0.1, toll_gate: 0.07, quiz_gate: 0.12, rock: 0.08, fence: 0.06, house: 0.06, shop: 0.04, campfire: 0.03 },
