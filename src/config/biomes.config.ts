...
export const BIOME_DEFS: BiomeDef[] = [
  ...
  },
  {
    ...
    baseColor: '#0f3d0f',
    terrainWeights: { grass: 0.5, dirt: 0.35, sand: 0.05, flower: 0.05, flower_pink: 0.03, mushroom: 0.02 },
    obstacleWeights: { tree: 0.28, tree_pine: 0.28, bush: 0.24, rock: 0.1, barricade: 0.05, quiz_gate: 0.05 },
  ...
  },
  {
    ...
    obstacleWeights: { rock: 0.45, wall: 0.25, door_locked: 0.12, toll_gate: 0.05, quiz_gate: 0.08, bush: 0.05 },
  ...
  },
  {
    ...
    obstacleWeights: { wall: 0.35, door_locked: 0.2, barricade: 0.12, toll_gate: 0.08, quiz_gate: 0.15, rock: 0.1 },
