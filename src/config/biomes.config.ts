...
export const BIOME_DEFS: BiomeDef[] = [
  {
    ...
    baseColor: '#1a5c1a',
    terrainWeights: { grass: 0.6, flower: 0.2, dirt: 0.15, sand: 0.05 },
    obstacleWeights: { rock: 0.3, bush: 0.5, tree: 0.2 },
  ...
  },
  {
    ...
    baseColor: '#0f3d0f',
    terrainWeights: { grass: 0.3, flower: 0.05, dirt: 0.2, mushroom: 0.1, bush: 0.35 },
    obstacleWeights: { tree: 0.6, bush: 0.2, rock: 0.1, barricade: 0.1 },
